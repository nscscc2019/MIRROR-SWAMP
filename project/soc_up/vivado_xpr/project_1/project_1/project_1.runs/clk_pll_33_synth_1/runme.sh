...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw/project/soc_up/vivado_xpr/project_1/project_1/project_1.runs/clk_pll_33_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_pll_33.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_pll_33.tcl
