...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw_final/project/soc_up/vivado_xpr/project_1/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_up_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_up_top.tcl
