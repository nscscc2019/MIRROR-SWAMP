...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw/project/soc_up/vivado_xpr/project_1/project_1/project_1.runs/axi_interconnect_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log axi_interconnect_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source axi_interconnect_0.tcl
