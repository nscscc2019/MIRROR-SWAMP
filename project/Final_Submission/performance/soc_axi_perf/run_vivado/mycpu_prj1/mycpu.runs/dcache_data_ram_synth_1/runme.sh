...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw_final/project/Final_Submission/performance/soc_axi_perf/run_vivado/mycpu_prj1/mycpu.runs/dcache_data_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dcache_data_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dcache_data_ram.tcl
