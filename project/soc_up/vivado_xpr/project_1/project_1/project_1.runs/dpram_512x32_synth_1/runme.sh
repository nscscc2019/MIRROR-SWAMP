...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw/project/soc_up/vivado_xpr/project_1/project_1/project_1.runs/dpram_512x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dpram_512x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dpram_512x32.tcl
