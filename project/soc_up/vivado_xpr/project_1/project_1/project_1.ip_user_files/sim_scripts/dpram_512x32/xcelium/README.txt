...
#
# Generated by export_simulation on Wed Jul 24 16:33:20 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './dpram_512x32.sh' script.

./dpram_512x32.sh -reset_run
...
./dpram_512x32.sh -noclean_files

For more information on the script, please type './dpram_512x32.sh -help'.
