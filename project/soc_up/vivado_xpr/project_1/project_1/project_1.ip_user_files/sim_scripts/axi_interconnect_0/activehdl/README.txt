...
#
# Generated by export_simulation on Wed Jul 24 16:32:59 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './axi_interconnect_0.sh' script.

./axi_interconnect_0.sh -reset_run
...
./axi_interconnect_0.sh -noclean_files

For more information on the script, please type './axi_interconnect_0.sh -help'.
