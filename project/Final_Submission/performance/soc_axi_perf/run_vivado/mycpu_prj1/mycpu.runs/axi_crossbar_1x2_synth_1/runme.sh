...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw_final/project/Final_Submission/performance/soc_axi_perf/run_vivado/mycpu_prj1/mycpu.runs/axi_crossbar_1x2_synth_1'
cd "$HD_PWD"
