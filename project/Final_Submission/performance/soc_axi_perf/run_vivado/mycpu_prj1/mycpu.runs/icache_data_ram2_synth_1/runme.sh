...
HD_PWD='C:/workpath/nscscc2019_ucas_llcw_final/project/Final_Submission/performance/soc_axi_perf/run_vivado/mycpu_prj1/mycpu.runs/icache_data_ram2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log icache_data_ram2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source icache_data_ram2.tcl
