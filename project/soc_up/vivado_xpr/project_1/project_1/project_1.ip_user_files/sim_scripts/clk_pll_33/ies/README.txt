...
#
# Generated by export_simulation on Wed Jul 24 16:33:13 +0800 2019
#
################################################################################
...
'-reset_run' switch to the './clk_pll_33.sh' script.

./clk_pll_33.sh -reset_run
...
./clk_pll_33.sh -noclean_files

For more information on the script, please type './clk_pll_33.sh -help'.
